...
window.initTheme = function () {
    console.log("🌓 Theme initialized via Native Event Handlers.");
...
window.toggleTheme = function () {
    ...
    // Mettre à jour l'icône du bouton (optionnel)
    if (themeToggle) {
                            ...
                            <div class="accordion-body" aria-hidden="true">
                                <div class="accordion-inner">
                                    <ul style="list-style:none; padding:0; margin:0;">
                                        ${(circuit.logistique_generale || {}).saison_ideale ? `<li style="margin-bottom:10px;"><strong><i class="fas fa-sun"></i> Saison Idéale:</strong> ${(circuit.logistique_generale || {}).saison_ideale}</li>` : ''}
                                        ...
                                        ${(circuit.logistique_generale || {}).route_etat ? `<li style="margin-bottom:10px;"><strong><i class="fas fa-road"></i> État de la route:</strong> ${(circuit.logistique_generale || {}).route_etat}</li>` : ''}
                                        ${circuit.infos.securite_level ? `<li style="margin-bottom:10px;"><strong><i class="fas fa-shield-alt"></i> Sécurité:</strong> ${circuit.infos.securite_level}</li>` : ''}
...
window.initLanguePage = function () {
    ...
    const categoryIcons = {
        ...
        'politesse': 'fa-heart',
        'se présenter': 'fa-user',
        'se déplacer': 'fa-map-marked-alt',
        'négocier': 'fa-handshake',
...
/**
 * Génère l'accordéon Infos Pratiques en PLEINE LARGEUR avec grille 3 colonnes
 */
/**
    ...
    <div class="step-accordion step-accordion-premium">
      <button class="step-accordion-header" onclick="window.toggleStepAccordion(this)" aria-expanded="true">
        <div class="step-accordion-header-main">
          ...
          <h4 class="step-accordion-title">Infos Pratiques de l'Étape</h4>
        </div>
          ...
          <details class="sub-accordion">
            <summary>
              ...
              <div>
                ...
                <span>Où bien manger sans se tromper</span>
              </div>
            </summary>
        ...
        ${hasAccom ? `
          <details class="sub-accordion">
            <summary>
              ...
              <div>
                <strong>Où poser ses valises ?</strong>
                <span>Nos adresses testées et approuvées</span>
              </div>
            </summary>
...
window.toggleStepAccordion = function (btn) {
    ...
    // Mettre à jour aria-hidden sur le contenu
                            ...
                            <button class="accordion-trigger" 
                                ...
                                <div class="accordion-header-content">
                                    ...
                                    <div class="accordion-text">
                                        ...
                                        <div class="accordion-subtitle">Horaires, conseils & équipement</div>
                                    </div>
                                </div>
                                <i class="fas fa-chevron-down chevron"></i>
                            </button>
                            <div class="accordion-body" aria-hidden="true">
                                <div class="accordion-inner">
                                    ...
                                    ${infos.meilleure_periode ? `
                                        <div style="margin-bottom: 18px;">
                                            <strong style="color: var(--laterite);"><i class="fas fa-sun"></i> Meilleure Période</strong>
                                            <div style="margin-top: 6px;">
                                    ...
                                    ${infos.a_prevoir ? `
                                        <div>
                                            <strong style="color: var(--laterite);"><i class="fas fa-backpack"></i> À Prévoir</strong>
                                            <div style="margin-top: 6px;">
                                                ${Array.isArray(infos.a_prevoir.equipement) ?
                    infos.a_prevoir.equipement.map(item => `<div>• ${item}</div>`).join('') :
 ...
 * ========================================
 */
// DEPRECATED: Remplacé par <details> HTML natif (Phase 1 PWA Mobile)
/*
...
/**
 * ========================================
 * ACCORDÉON PREMIUM V3 - Toggle avec ARIA
 * ========================================
 */
